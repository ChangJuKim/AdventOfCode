package advent_of_code_2022.problem_05.part2;
...
public class StackCratesWithMultiple {
    ...
    private static ArrayList<LinkedList<Character>> moveCrates(ArrayList<LinkedList<Character>> crates, Integer[] instructions) {
        ...
        for (int i = numCrates - 1; i >= 0; i--) {
            crates.get(toIndex).addFirst(crates.get(fromIndex).get(i));
            crates.get(fromIndex).remove(i);
        }
        return crates;
    }
}

package advent_of_code_2022.problem_11.part2;
...
public class SimulateWorrisomeMonkeyShenanigans {
    ...
    public static long productOfTopMonkeyShenanigans(String[] input) {
        Monkey[] monkeys = parseInputAndGetMonkeys(input);
        long[] numTimesMonkeysInspected = countInspectedOverRounds(monkeys);
        return getProductOfTopTwoValues(numTimesMonkeysInspected);
    }

    private static long[] countInspectedOverRounds(Monkey[] monkeys) {
        long[] count = new long[monkeys.length];
        ...
        PrintArray.printArray(count);

        return count;
    }
    
    private static long getProductOfTopTwoValues(long[] values) {
    ...
    private static Monkey[] parseInputAndGetMonkeys(String[] input) {
        ...
        // Product of all monkeys' tests
        int totalWorryDivider = 1;
        ...
        for (Monkey monkey : monkeyList) {
            ...
            // Also update worrisome divider to the product of every monkey's tests
            monkey.setWorrysomeDivider(totalWorryDivider);
        }
